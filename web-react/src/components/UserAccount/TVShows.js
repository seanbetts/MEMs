...
const GET_MEM = gql`
  {
    Mem(memType: "TVShow", orderBy: date_asc) {
      memID
      mem
      date {
        formatted
...
const TVShows = () => {
    ...
    const renderFavourite = (favourite) => {
        if ((favourite === true)) {
            return <IconButton style={{ margin: "0px", padding: "10px", marginLeft: "0px", color: "red" }} aria-label="add to favorites">
                <FavoriteIcon />
            </IconButton>
        } else {
            return <IconButton style={{ margin: "0px", padding: "10px", marginLeft: "0px" }} aria-label="add to favorites">
                <FavoriteIcon />
            </IconButton>
        }
    }
    ...
    const renderPublic = (memPublic) => {
        if ((memPublic === true)) {
            return <IconButton style={{ margin: "0px", padding: "10px", color: "green" }} aria-label="make public">
                <PublicIcon />
            </IconButton>
        } else {
            return <IconButton style={{ margin: "0px", padding: "10px" }} aria-label="make public">
                <PublicIcon />
            </IconButton>
        }
    }
